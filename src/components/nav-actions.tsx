...
export function NavActions({
    ...
    currentLang: string,
    dict: { pricing: string, terminalAccess: string }
}) {
    ...
    return (
        <div className="flex items-center gap-4 sm:gap-6">
            ...
            <Link href={`/${currentLang}/pricing`} className="flex items-center justify-center text-sm font-bold text-slate-600 hover:text-slate-900 transition-colors px-5 py-3 sm:px-4 sm:py-2 rounded-full hover:bg-slate-200/50 active:bg-slate-200 min-h-[44px] min-w-[80px]">
                {dict.pricing}
            </Link>
            {isUnlocked && (
                <Link
