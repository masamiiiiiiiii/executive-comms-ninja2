        ...
        try {
            ...
            if (!transcript || transcript.length < 100) {
                ...
                try {
                    ...
                    if (!transcriptRes.ok) {
                        toast.info("Transcript unavailable. Switching to AI Voice Analysis...", { id: "transcript", duration: 4000 });
                        // We continue without transcript - the backend will handle audio download
                        transcript = "";
                    } else {
                    ...
                    toast.info("Switching to multimodal AI voice analysis...", { id: "transcript", duration: 4000 });
                    transcript = "";
                }
            }
